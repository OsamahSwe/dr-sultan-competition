    ...
    <main className={`min-h-screen ${mainClass}`} style={{ backgroundColor: isLightMode ? "#ffffff" : "#000000" }}>
      ...
      <div className="md:hidden sticky top-[60px] z-40 backdrop-blur-xl border-b" style={{
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <button
            onClick={() => navigate(-1)}
            className={`inline-flex items-center gap-2 text-sm font-medium ${subheadingClass} hover:opacity-70 transition-opacity`}
          >
          ...
          <a
            ...
            className={`inline-flex items-center gap-2 px-3 py-2 rounded-full text-xs font-medium ${
              isLightMode ? "bg-teal-600 text-white hover:bg-teal-700" : "bg-teal-500 text-black hover:bg-teal-400"
            } transition-colors`}
          >
            {t("visitSite")}
