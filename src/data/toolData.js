...
export const toolsData = {
  ...
  codex: {
    ...
    overview: "OpenAI Codex represents cutting-edge code generation capabilities. While Codex itself is primarily available through integrations, it represents the foundation of modern AI-assisted development tools.",
    ...
    howToUse: [
      ...
      },
      {
        ...
        description: "Decide whether to use Codex through existing tools or build custom integrations."
      },
      {
        step: 3,
